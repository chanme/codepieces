/**
 * codepieces from mongodb, from the code one could learn the basic strategy of wrtting a lru_cache using
 * the basic std::list and std::unordered_map
 * 1. stdx::unordered_map<K, V, Hash>::key_equal actually refers to absl::unordered_map instead of typical std::unordered_map, it has its advantage.
 * 2. using std::list.splice to do the promote is elegant.
 * 3. there is a lot of std::move, I still can't understand the advantages
 * /
